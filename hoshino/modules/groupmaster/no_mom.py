...
from hoshino import logger, util, Service, R, priv

sv = Service('btfchs-no-mom', manage_priv=priv.SUPERUSER, enable_on_default=False, visible=True)

@sv.on_rex(re.compile(r'rbq|RBQ|憨批|废物|死妈|崽种|傻逼|傻逼玩意|没用东西|傻B|傻b|SB|sb|煞笔|cnm|爬|kkp|nmsl|D区|口区|我是你爹|nmbiss|弱智|给爷爬|杂种爬|你妈死了|杂种|叼毛|露逼|露屄|草泥马|操你妈|草你妈|婊子|死了|撒了你|杀了|你妈|憨憨|rnm|snm'), normalize=True)#正则匹配素质文本
